...
const teamMembers = [
  ...
  { name: "Mr. Kanchan Sarkhel", role: "Business Management Consultant", image: "/images/team/kanchan_sarkhel_v2.png" },
  { name: "Ms. Swara Patel", role: "Technical Management Consultant", image: "/images/team/swara_patel_v2.jpg" },
  { name: "Kavya Oza", role: "Senior Technical analyst", image: "/images/team/kavya_oza.jpg" },
  { name: "Kajal Modhavadiya", role: "Senior Technical Consultant", image: "/images/team/khushali_chauhan.jpg" },
  { name: "Khushali Chauhan", role: "Senior Technical analyst", image: "/images/team/kajal_modhavadiya.jpg" },
  { name: "Meera Patel", role: "Senior Technical Consultant", image: "/images/team/krisha_kothari.png" },
  { name: "Krisha Kothari", role: "Technical analyst", image: "/images/team/diya_modhavadiya.png" },
  { name: "Kiara Patel", role: "Technical analyst", image: "/images/team/meera_patel.jpg" },
  { name: "Siya Odedara", role: "Technical analyst", image: "/images/team/siya_odedara.png" },
  { name: "Diya Modhavadiya", role: "Technical analyst", image: "/images/team/kiara_patel.png" },
];
    ...
    <>
      ...
      <div className="relative z-10 bg-[#FFFFF0] shadow-[0_-15px_30px_rgba(0,0,0,0.05)]">
        ...
        <section className="py-20 px-5 lg:px-[5%] 2xl:px-[15%]">
          <div className="relative bg-[#00C9FF]/15 rounded-3xl p-10 md:p-16 text-center overflow-hidden">
            <div className="absolute -top-60 -right-44 flex items-center justify-center h-96 w-96 rounded-full bg-[#AE70BB]/10 z-0">
              <div className="bg-[#E5FAF1] h-72 w-72 rounded-full"></div>
            </div>
            <div className="absolute -bottom-48 -left-44 flex items-center justify-center h-80 w-80 rounded-full bg-[#72B76A]/20 z-0">
              <div className="bg-[#E5FAF1] h-56 w-56 rounded-full"></div>
            </div>
            <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
              {[
                { num: "10K+", label: "Skilled Candidates" },
                { num: "400+", label: "Verified Recruiters" },
                { num: "100+", label: "Industries Covered" },
                { num: "25+", label: "Years Experience" }
              ].map((stat, idx) => (
                <div key={idx} className="flex flex-col items-center justify-center border-r border-gray-200 last:border-0">
                  <p className="text-4xl md:text-5xl font-extrabold text-[#00C9FF] mb-2">{stat.num}</p>
                  <p className="text-sm md:text-base text-gray-700 font-medium uppercase tracking-wider">{stat.label}</p>
                </div>
              ))}
            </div>
          </div>
